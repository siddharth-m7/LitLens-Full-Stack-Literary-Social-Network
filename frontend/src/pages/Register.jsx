    ...
    <div className="min-h-screen bg-[#FAF6EE] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#FAF6EE] border-r border-[#E8E0CE] flex-col justify-between p-16">
        ...
        <div>
          ...
          <p className="text-gray-500 text-base">— Ernest Hemingway</p>
          <div className="w-12 h-px bg-gray-300 mt-8"></div>
          <p className="text-gray-500 text-sm mt-4">
            Join thousands of readers. Track what you've read, share your reviews, and discover what to read next.
          </p>
        </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="mt-1.5 text-xs text-gray-400">Password must be at least 6 characters</p>
            </div>
